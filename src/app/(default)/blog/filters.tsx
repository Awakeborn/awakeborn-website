...
import { useCategoryProvider } from "../../../../components/category-provider";
...
export default function BlogFilters() {
  ...
  return (
    <div className="flex justify-center pb-12 max-md:hidden md:pb-20">
      <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1 gap-2">
        {/* Button #1 */}
        <button
          className={`cursor-pointer flex h-9 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-5 text-base font-semibold shadow transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400/40
            ${category === "All"
              ? "relative bg-gradient-to-r from-purple-500 via-pink-400 to-blue-500 text-white shadow-lg scale-105 ring-2 ring-purple-400/30 drop-shadow-[0_2px_8px_rgba(168,85,247,0.25)]"
              : "bg-gray-900/70 text-indigo-200/80 opacity-80 hover:opacity-100 hover:scale-105"}
          `}
          aria-pressed={category === "All"}
          onClick={() => setCategory("All")}
        >
          <svg
            className={`fill-current ${category === "All" ? "text-white" : "text-indigo-400"}`}
        ...
        >
          <svg
            className={`fill-current ${category === "AI Content" ? "text-white" : "text-indigo-400"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
        ...
        >
          <svg
            className={`fill-current ${category === "Automation" ? "text-white" : "text-indigo-400"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
        ...
        >
          <svg
            className={`fill-current ${category === "Customer Service" ? "text-white" : "text-indigo-400"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
        ...
        >
          <svg
            className={`fill-current ${category === "Engineering" ? "text-white" : "text-indigo-400"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
